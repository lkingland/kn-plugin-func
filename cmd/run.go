...
`,
	...
	cmd.Flags().BoolP("container", "t", true, "Run the function in a container. ($FUNC_CONTAINER)")
...
type runConfig struct {
	...
	// Container indicates the funciton should be run in a container.
...
func (c runConfig) Validate(cmd *cobra.Command, f fn.Function) (err error) {
	...
	// than Go such that they do not receive the cryptic "no runner defined"
	...
	// not yet implemented.
	if c.Container == false && f.Runtime != "go" {
